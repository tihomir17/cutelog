...
class SettingsDialog(QDialog):
    ...
    def setup_tooltips(self):
        self.benchmarkCheckBox.setToolTip(
            "Has effect after restarting the server, "
            "<b>for testing purposes only</b>."
        )

        self.singleTabCheckBox.setToolTip(
            "Forces all connections into one tab. "
    ...
    def save_to_config(self):
        ...
        o[
            "search_casesensitive_default"
        ] = self.searchCaseSensitiveDefaultCheckBox.isChecked()
